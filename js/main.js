...
function converter() {
    ...
    div_resultado.innerHTML = `<br><p>Valor digitado (BRL): R$${valorEmReais}</p>`
    ...
    if (moedaEscolhida == 'euro') {
        ...
        div_resultado.innerHTML += `<p>Opção inválida. Escolha uma moeda para realizar a conversão.</p>`
    }
}
